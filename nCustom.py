...
def banner():
    ...
    print(" .-----.|     \\.-----.--.--.--.-----.|  |.-----.---.-.--|  |.-----.----.")
    print(" |     ||  --  |  _  |  |  |  |     ||  ||  _  |  _  |  _  ||  -__|   _|")
    print(" |__|__||_____/|_____|________|__|__||__||_____|___._|_____||_____|__|   Made by r4v10l1")
    ...
    while True:
        ...
        try:
            ...
            if r.headers["content-type"] not in images:  # Check if we did not get an image from the request
                ...
                exit(1)
            elif r.headers["content-type"] in images:  # If we got an image from the request
